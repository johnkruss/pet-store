...
class TestRepositoryInitializer {
    ...
    fun create() {
        dynamoDb = dynamoDbClientBuilder
    ...
    fun withHashKey(hashKey: String): TestRepositoryInitializer {
        keySchemaElements.add(hashKeySchemaElementBuilder
                .attributeName(hashKey)
                .keyType(KeyType.HASH)
                .build())
        if (definitionsNeedsKey(hashKey)) {
            definitions.add(attributeDefinitionBuilder
                    .attributeName(hashKey)
    ...
    fun withSortKey(sortKey: String): TestRepositoryInitializer {
        keySchemaElements.add(sortKeySchemaElementBuilder
    ...
    fun withProvisionedThroughput(readCapacityUnits: Long,
                                  writeCapacityUnits: Long): TestRepositoryInitializer {
